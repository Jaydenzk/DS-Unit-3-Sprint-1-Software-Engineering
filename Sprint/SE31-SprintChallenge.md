...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  Containers are helpful for standardize the environments. Users can access these libraries, packages and systems already set it up on       containers for their work and they can run same environment that users can collaborates their work much easier than before.
