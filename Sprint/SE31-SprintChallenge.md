...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  Containers are helpful for standardize the environments. Users can access these libraries, packages and systems already set it up on       containers for their work and can run same environments which it makes collaborate work much easier than before.
