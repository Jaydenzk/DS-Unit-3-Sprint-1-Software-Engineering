...
- An important part of code reviews is making sure that the code is legible to others 
  because when you're working with a team they need to be able to read your code. 
  The Code needs to be properly formatted to make it easier to read.

- Containers help software is reproducible in any environment that all the libraries doesn't need to be installed everytime on new computer/other devices. 
